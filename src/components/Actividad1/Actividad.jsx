...
const Actividad_base =  ({staticContext,...props}) => {
    ...
    return (
        <Container bgImage='./src/bg_actividad1.png' w={69} h={38.8} {...props}>
            ...
            <UiButtonsContainer>
                <ButtonUi icon='ilx-ayuda' tooltip='Organize the words to make the correct sentences, then press check to verify if it is right or wrong, press hint if you need help   ' />
            ...
            <IRow w={90} align='center' pt={2}>
                <ICol w={100}> 
                    ...
                    <Sentence basename='To' words={[{id:0, name: 'write'}, {id:2, name: 'the'}, {id:3, name: 'recipient`s'}, {id:4, name: 'email'}, {id:5, name: 'in'}, {id:6, name: 'this'}, {id:7, name: 'part'}]}  sendFeedback={(info)=>{ registerFeedBack(info)}} />
                    ...
                    <Sentence basename='Attachments' words={[{id: 0, name: 'here'},{id: 1, name:  'you'},{id: 2, name:  'include'},{id: 3, name:  'a'}, {id: 4, name: 'document'}, {id: 5, name: 'or'}, {id: 6, name: 'photo'}, {id: 7, name: 'to'}, {id: 8, name: 'the'}, {id: 9, name: 'email'}, {id: 10, name: 'message'}]}  sendFeedback={(info)=>{ registerFeedBack(info)}} />
                </ICol>
            </IRow>
